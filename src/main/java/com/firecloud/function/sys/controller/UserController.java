...
import com.firecloud.function.sys.common.PinyinUtils;
...
import com.firecloud.function.sys.vo.UserVo;
...
public class UserController {
    ...
    public DataGridView loadAllUser(UserVo userVo) {
        ...
        queryWrapper.eq(StringUtils.isNoneBlank(userVo.getName()),"loginname",userVo.getName())
